...
如果您还没有控制台代理，请创建一个。看link:https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-aws.html["在 AWS 中创建控制台代理"^]，link:https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-azure.html["在 Azure 中创建控制台代理"^] ， 或者link:https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-google.html["在 GCP 中创建控制台代理"^]。

[role="quick-margin-para"]
你也可以link:https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-on-prem.html["在本地安装控制台代理"^]在您网络中的 Linux 主机上，或者在云端的 Linux 主机上。

.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["两个"]先决条件
[role="quick-margin-para"]
确保您的环境能够满足先决条件。这包括实例的出站互联网访问、Console 代理与 Data Classification 在端口 443 上的连接等。<<前提条件,查看完整列表>>。
...
如果您还没有 Console 代理，请在云提供商中创建 Console 代理。请参阅 https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-aws.html["在 AWS 中创建控制台代理"^]或 https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-azure.html["在 Azure 中创建控制台代理"^]，或 https://docs.netapp.com/us-en/console-setup-admin/concept-install-options-google.html["在 GCP 中创建控制台代理"^]。在大多数情况下，您可能在尝试激活 Data Classification 之前已经设置了 Console 代理，因为大多数 https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-on-prem.html["控制台功能需要控制台代理"]，但在某些情况下您需要立即设置一个。
...
请注意，您也可以 https://docs.netapp.com/us-en/console-setup-admin/task-install-connector-on-prem.html["在本地安装控制台代理"^]在网络或云端的 Linux 主机上。一些计划在本地安装数据分类的用户可能还会选择在本地安装控制台代理。

可能有些情况下你需要使用 https://docs.netapp.com/us-en/console-setup-admin/concept-agents.html#multiple-systems-and-agents["多个控制台代理"^]。
...
link:https://docs.netapp.com/us-en/console-setup-admin/task-install-restricted-mode.html["了解如何在政府区域部署控制台代理"^]。
...
* link:https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-resource-limits.html["AWS 文档：Amazon EC2 服务配额"^]
* link:https://docs.microsoft.com/en-us/azure/virtual-machines/linux/quotas["Azure 文档：虚拟机 vCPU 配额"^]
* link:https://docs.cloud.google.com/docs/quotas/view-manage["Google Cloud 文档：资源配额"^]
