...
summary: 要在网络中的 Linux 主机或具有互联网访问权限的云中的 Linux 主机上安装 NetApp Data Classification，需要在网络或云中手动部署 Linux 主机。 
---
...
.步骤
. 从 https://mysupport.netapp.com/site/products/all/details/cloud-data-sense/downloads-tab/["NetApp 支持站点"^]下载 Data Classification 软件。选择名为 *DATASENSE-INSTALLER-<version>.tar.gz* 的文件。
